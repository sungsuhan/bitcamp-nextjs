...
export default function Nav(){
  ...
  const userUrls = ["/user/join","/user/login","/user/logout","/user/profile","/user/modifyUser","/user/withdrawUser","user/getUser"]
  ...
  const boardUrls = ["/board/writeArticle","/board/getArticle","/board/modifyArticle","/board/removeArticle"]
